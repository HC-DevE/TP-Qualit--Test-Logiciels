...
the visitor creates a new user
    ...
    Wait Until Page Contains Element    //h6[text()='Add Employee']
    Input Text
    ...
    Wait Until Page Contains Element    //h6[text()='Personal Details']
...
the visitor search the new modified user
    ...
    Click Button    //button[text()=' Search ']
    # Sleep    2s
    Wait Until Page Contains Element    //i[contains(@class, 'oxd-icon bi-pencil-fill')][1]
